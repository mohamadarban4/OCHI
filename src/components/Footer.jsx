...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20 font-['Test_Founders_Grotesk_X-Condensed']">
      ...
      <div className="w-1/2">
        ...
        <div className="dets font-['Neue_Montreal'] mt-20 font-thin">
          {["Facebook", "Instagram", "Twitter"].map((item, index) => (
            <a className="block text-xl" key={index}>
              {item}
            </a>
          ))}
        </div>
